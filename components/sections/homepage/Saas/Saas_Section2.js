                                ...
                                <div className="block-list layout-03">
                                    <ul>
                                        <li>
                                            ...
                                            <h4 className="title size-l" style={{paddingLeft: 64}}>Create Plan</h4>
                                            <p className="desc"style={{paddingLeft: 64}}>Lorem Ipsum is simply dummy text of the printing</p>
                                        </li>
                                        <li>
                                            <span className="number background-navy">2</span>
                                            <h4 className="title size-l"style={{paddingLeft: 64}}>Apply</h4>
                                            <p className="desc"style={{paddingLeft: 64}}>Lorem Ipsum is simply dummy text of the printing</p>
                                        </li>
                                        <li>
                                            <span className="number background-navy">3</span>
                                            <h4 className="title size-l"style={{paddingLeft: 64}}>Get Covered</h4>
                                            <p className="desc"style={{paddingLeft: 64}}>Lorem Ipsum is simply dummy text of the printing</p>
                                        </li>
                                    </ul>
                                </div>
